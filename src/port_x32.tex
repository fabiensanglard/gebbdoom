...
\drawing{x32_arch}{X32 Core Architecture.}
...
Besides the dual SH2, the X32 was gifted an impressive audio chip from QSound. Capable of Pulse Wave Modulation, it added extra channels and even had a multidimensional sound capability allowing a regular stereo audio signal to approximate the 3D sounds heard in everyday life. Also present, a chip name "VDP" in charge of double buffering (to avoid tearing)  also capable to clear the framebuffers.
\par

\pngdrawing{x32_fullarch}{The X32 system as summarized in the developer documentation.}
...
\par
With engineers pouring their heart into the system and DevRel doing amazing work to have a decent portfolio of games for launch date, the X32 managed to sell 665,000 units at the end of 1994. A promising start...but rest is a sad story.\\
\par
...
What crippled Mars was Saturn. During 1994 in SOJ, work on the 32-bit system had gone well. So well Sega decided to release it in Japan way ahead of what was originally scheduled on November 1994. The same month the X32 was to be released in USA.\\
...
\par
To make the game fit in the little RAM the 32X had, even more features than the Jaguar version had to be cut. An other enemy was removed (Spectre). All eight poses of each monsters was removed except for the one facing the player. Since they could no longer point at each others, monster infighting was also removed. There were no save games. Only seventeen heavily edited maps made the cut and since none of theme had the BFG9000, the weapon is unavailable without cheating.\\
\par
...
\par
Map rework necessary could be very subtle or chainsaw style. Above, E1M1 main room was stripped of many textures (compare with PC version on page XXX). Below, the "pit" of E1M2 was been flattened to lower visplane count.\\
\par
