...
% \end{wrapfigure}
What is remarkable with this version is how Rany decided to cut different corners than the other console ports for his engine.\\
\par
...
\par
Out of the native 256 x 224 resolution, only 216x176 were actually drawn and only 216x144 for the 3D canvas (32 pixels tall for the status bar). With vertical lines duplicated, Reality Engine was actually rendering at 108x144. Even at this low resolution, the average framerate was around 10fps which was a remarkable achievement but not good enough to appease gamers and critics. Despite the breathtaking engineering that went into it, the SNES port did not sell well.
