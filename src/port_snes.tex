...
\par
To retrieve the assets, Randy was able to leverage the "Unofficial Doom Specs" by Matthew Fell which explained the \cw{.wad} lumps layout well. The sprites, textures, music, sound effects and maps were extracted from \cw{DOOM.WAD}. The engine was an entirely different story.\\
\par
