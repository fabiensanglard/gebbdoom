...
\par
Opening the machine reveal a clean board with \circled{1} TOM, \circled{2} 2 MiB RAM, \circled{3} JERRY, \circled{4} 8-bit Motorola 68000, \circled{5} Operating System ROM, \circled{6} Cartridge slot, \circled{7} Joystick ports, \circled{8}, \circled{9}, \circled{A} and , \circled{B}\\
\par
...
\ccode{jaguar_src.c}
\par
\cw{MARS} was the code name of the Sega Genesis X32 expansion. Jaguar ran at resolution of 320x240. Due to limitations the 3D scene is actually renderer in 160 x 180 (vertical lines doubled) with 60 pixels at the botton.\\
