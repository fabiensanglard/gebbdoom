...
If additional archives are provided via the \cw{-file} command-line parameter, lumps belonging to official id Software WADs (\cw{DOOM1.WAD}, \cw{DOOM2.WAD},...) are added to the \cw{lumpinfo} array first.\\
\par
