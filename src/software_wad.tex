...
\par
\drawing{lumpsMaster}{For simplicity of drawing, \cw{DOOM1.WAD} is represented with only three lumps and the two additional WAD archive have only one lump each.}
\par
