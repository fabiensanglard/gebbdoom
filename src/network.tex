...
\cscaledimage{0.9}{robotic28-8.png}{US Robotic 28.8 bauds modem. The top of the line in 1994.}
 ...
 \par 
\cfullimage{spectrogram2.png}{Spectrogram of a V.34 handshake\protect\footnotemark }
\par
...
\end{figure}
\par
\trivia{The fragility of early connection were subject of many jokes. An humorous way to end a message was to type some garbage followed by "Hey! Wait! Don't pick up the ph\{\#`\%\$\{\%\&`+'\$\{`\%\&NO CARRIER".}