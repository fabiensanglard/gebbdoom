...
\par
On top of the V.XX hardware communication layer, modems were driven using Hayes commands. Notice how command \cw{ATDT} was translated to DTMF in the previous spectogram in figure \ref{spectrogram2.png} on page \pageref{spectrogram2.png}.\\
