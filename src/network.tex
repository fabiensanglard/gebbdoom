...
\par
On top of the V.XX hardware communication layer, modems were driven using Hayes commands\footnote{A nice abstraction layer, but not   all modems were the same and \doom{} has a long file with initialization parameters for 49 different modems.}. Notice how the command \cw{ATDT} was translated to DTMF in the previous spectrogram.\\% in figure \ref{spectrogram2.png} on page \pageref{spectrogram2.png}.\\
