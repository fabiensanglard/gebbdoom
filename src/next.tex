...
\par
\cscaledimage{1}{credits/DoomCREDIT10.png}{Credit featuring "NeXT Computers" was removed when NeXT refused to be associated with \doom. After release, NeXT requainted but by then "that ship has sailed".}
\par
