...
\par
Released in 1987, the 32-bit 68030 was the latest in Motorola's 68000 series. A choice likely influenced by the experience NeXT hardware engineers had built while working on Apple's Macintosh and Lisa (both were powered by a 68000). Running at 25Mhz, it was able to generate close to 5 Mips. The chip did not feature a built-in FPU so a Motorola 68882 was placed next to the CPU on the motherboard. %\footnote{Of course, Motorola documentation claimed almost double that with 12 Mips!}
...
\cfullimage{next/NeXTDimension.png}{An early NeXTDimension ad from NeXT 1991 brochure. Notice the C-Cube Microsystems JPeg chip which had to be cut from the final design.}
\pagebreak
...
The first three points were the hardware team responsibility. However the rest was on the software team and the amount of work ahead of them was overwhelming. No operating system was capable of delivering their vision. They had to build it.\\
\par
...
\par
On the previous page, NeXTSTep running on a color capable machine. Notice the opened \cw{Mail.app} featuring an email from Steve Jobs vaunting the merits of Object Oriented Programming.
...
\par
However when prompting other team members such as John Romero, it was a black and white NextCube.\\
\par
...
\par
John Romero in particular liked their production pipeline so much that he made it its champion. He managed to successfully advertise it to other gaming studio.\\
\par
\fq{
...
\par
\cscaledimage{1}{credits/DoomCREDIT10.png}{Credit featuring "NeXT Computers" was removed when NeXT refused to be associated with \doom. After release, NeXT requainted but by then "that ship had sailed".}
\par
