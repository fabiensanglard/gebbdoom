...
\vspace{50 mm}
\drawing{NeXTCube_motherboard}{NeXTCube mothboard diagram}
\par
...
\par
%\trivia{The NeXTCube shape would see a third iteration. In 2000, with many NeXT people now at Apple, the company shipped an other cubic device: The Power Mac G4 Cube.}
\trivia{The NeXTCube Turbo extension slot could welcome a Nitro board which replaced the 68040 33Mhz with a 68040 40 Mhz. Only 10 Nitro board are known to exist, they are extremely rare and highly seeked after by collectors.}
\pagebreak
...
\circled{4} Motorola U88,
\circled{5} BT463 ramdac,
\circled{6} Motorola U52,
