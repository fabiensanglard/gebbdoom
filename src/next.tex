...
\par
The NextCube Turbo released in 1992 was essentially the same machine except the 68040 frequency was bumped to 33 Mhz and the maximum RAM capacity increased to 128 MB.\\
\par
...
\trivia{The NeXTCube Turbo extension slot could welcome a Nitro board which replaced the 68040 33Mhz with a 68040 40 Mhz. Only 10 Nitro board are known to exist, they are extremely rare and highly sought after by collectors.}
\pagebreak
...
The first three points were the hardware team responsibility. Everything else was on the software team and the amount of work ahead of them was overwhelming. The magical operating system described did not exist in 86. To deliver their vision, they had to build it.\\
\par
...
\vspace{6mm} \label{nextstep_color.png}
% \scaledimage{0.95}{nextstep_color.png} 
\fullimage{nextstep_color.png}
\par
On page \pageref{nextstep_color.png}, a screenshot from NeXTSTep running on a 24-bit colors machine was more gorgeous than any of its competitors was capable of. Notice \cw{Mail.app} which shipped with an email from Steve Jobs vaunting the merits of Object Oriented Programming.
...
\par
\fq{Develop for it? I'll piss on it!}{- Bill Gates (never published but told to an InfoWorld reporter).}\\
\par
...
\subsection{Rebirth}
The rest of \NeXT history has nothing to envy to an Hollywoodian plot-twist. In 1995, Apple Computer's failed attempt at producing its own operating system under project "Copland" had placed the company in a precarious situation with nothing to replace its outdated System 7.\\
\par
...
\par
NeXTSTEP was used as foundation for Apple's Rhapsody project which became Darwin (a.k.a MacOS X). The new operating system was met with enthousiam by customers and professionals who praised the design, look and feel, and stability. MacOS X was later used as a base for Apple's 2008 iPhone which took over the world by storm. It is extremely likely some of the code that once ran on NeXTSTEP and contributed to \doom{} now runs on the many millions of Apple computer and iOS phones across the world.\\
