...
\rawdrawing{sb16}
\par
Above, a Sound Blaster 16 model CT1740 from 1994. \circled{1} Panasonic/Matsushita connector (for CD-ROM), \circled{2} C1741 DSP Chip, \circled{3} C1748 ASP chip, \circled{4} CT1746B Bus Interface, \circled{5}, 46.61512 Mhz Timer, \circled{6} CT1745A Mixer, \circled{7} Extension Interface for wavetable capable WaveBlaster daughtercard, and \circled{8} mic-in, line-in, volume wheel, line-out, joystick port.
