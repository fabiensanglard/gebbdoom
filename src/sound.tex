...
\par
It rapidly developed a cult following among demomakers who loved the high music quality it could achieve. On the lambda customer side however, things were more complicated. OPL2 emulation was unreliable and complicated (a huge TSR emulator had to be loaded manually by the user). It also suffered of an unfortunate release date concurrent to the RAM shortage of 1993/1994. Players were reluctant to fork the \$169 it cost which was \$40 more than a Sound Blaster 16. With sales plummeting, Gravis almost went bankrupt.\\
\par
