...
\par
 At this point, the engine had everything it needed to communicate in a generic way. It writes or read from \cw{doomcom\_t} and to trigger read/write, it uses the interrupt \# also provided in \cw{doomcom\_t}.\\
\par
