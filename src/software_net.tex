...
Given the complexity of the command-line parameters to setup a network game, several tools were provided. Originally players could use \cw{SETUP.EXE}. In December 1994, id Software introduced \cw{DM.EXE} (DeathManager) which was easier to use.\\
\par
