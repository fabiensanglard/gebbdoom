...
\triva{DeathManager is a 16-bit program that appears to have been written in Turbo C - as many of the other Doom utility programs were. Unlike the other utilities, the source code to DeathManager has never been released.}