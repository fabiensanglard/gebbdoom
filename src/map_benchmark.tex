...
\par
The 320x200 Interceptor VGA Console \cw{NSWindow} is not stretched to 320x240 and therefore appears vertically squashed. It is particularly noticeable when the splash screen is displayed.\\
\par
\cfullimage{doom_crushed}{\doom{} on NeXTSTEP. Content appears vertically squashed}
\par
\trivia{The aspect ratio is something a lot of port got wrong. \doom{}95, dedicated to showcasing Microsoft's Windows 95 graphics driver low overheard was among the guilty. In its default setting, the hosting window is set to 320x200 and directly maps the \doom{}'s core framebuffer. As a result, enemies look shorter, rocket explosions are oval, and everything else is distorted.}
\par
\cfullimage{doom_title_4_3}{\doom{} in 4:3 aspect ratio as presented on a 1993 monitor}
