...
\par
\trivia{Many ports got the aspect ratio wrong. \doom{} 95 which was to showcase Microsoft's Windows 95 graphics drivers low overhead was among the guilty. In its default setting, the 320x200 hosting window directly maps the \doom{}'s core framebuffer. As a result, enemies look shorter, rocket explosions are oval, and everything else is distorted.}
\par
