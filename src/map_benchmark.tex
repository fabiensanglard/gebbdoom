...
\par
\trivia{The "low detail" mode was never properly implemented on NeXTSTEP. The engine writes only half the columns but there is no system to duplicate them like the VGA bank mask did. As a result, only the left portion of the window is updated.}
