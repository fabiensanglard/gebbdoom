...
\vspace{-4mm}
On \NeXTns{}, the video system is very different than DOS. The implementation disregards updates signal from \cw{I\_} and defer all work to \cw{I\_FinishUpdate} where the full content of framebuffer \#0 is blited to \cw{NSWindow} so it does not benefit as much as it should from "reduced canvas size".\\
\par
