...
\par
If that did not scream "buffer over-read" to you, the fact that \cw{29} worked on DOOM v1.9 only while a value of \cw{31} was required for Final DOOM should achieve to convince you.\\
\par 
