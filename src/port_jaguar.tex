...
\par
\trivia{To ease the task of generating RISC instructions for Tom \& Jerry, John Carmack wrote its own \cw{lcc} compiler backend which generated Tom\&Jerry RISC instructions.\footnote{\cw{lcc} was also used for Quake 3 to generate the VMs bytecode.}}\\
\par
