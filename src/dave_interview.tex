Dave Taylor was kind enough to allow an interview.\\


\section{Q \& A }

How old were you in 1992 when you started working at id?\\ \par
\rawfq{I started studying the Sega Genesis tech docs in order to do a Sega Wolf3D port at the beginning of summer 1993, but by the end of summer when I started, I was assigned to Doom instead.  I was 24 when I started.}{}
\par
...
How advanced was doom development when you joined?\\ \par
\rawfq{The core 3D gameplay window was there, most of the art was in, the single-player gameplay was almost all there.  I integrated the sound code/effects, the automap, status bar, screen wipes, level transitions, and cheat codes.}{}
\par

Who did you report to, how did you know what to work on ? \\ \par
\rawfq{I reported to John Carmack, but I wasn’t easy to manage and would often do my own thing.}{}
\par


I can see you have a NeXT workstation on your desk. What did you use it for? \\ \par
\rawfq{We used them to make the whole game, and that’s what the level editor ran on.  DOS 3.3 was our target OS, and DOS wasn’t really a complete operating system (no sound or video drivers, for example, and no debugger to speak of), so it was pretty painful to debug on.  NeXTStep was much faster and easier to iterate on.}{}
\par
...
\rawfq{Man, it’s been a while.  I think I just took care of the page-swapping for memory access and the page-flipping on update.  It wasn’t much code.}{}
\par


You wrote ports for IRIX, AIX, Solaris and Linux. What is for both Doom and Quake ?\\ \par
\rawfq{For Doom, ya.  For Quake, Linux for sure, but the others, I can’t remember.}{}
\par
...
What is the most memorable outline of you unconscious marked with masking tape in the office (I would like to include it in the layout for fun) |  Or the one that stayed on place the longest before the cleaning crew removed it.\\ \par

\rawfq{ I fell asleep on the floors a lot, which is why they got the sofa and had me test-drive it for comfort, but I only remember them taping my outline once.  I believe it stuck around for a while though.}{}
\par


When did you leave id software ?\\ \par
\rawfq{I believe I left in early 1996, just after qtest1 shipped.}{}
\par


Leaving was a courageous decision, you could have made a lot more money. I assume you dreamed of making your own game: Do you regret leaving so "early" ?\\ \par
\rawfq{Actually, not brave.  I asked when I hired on to get some ownership in id, and after the 6mo trial period, they decided against giving out more ownership, they said because it hadn’t worked out with a couple of previous folks, and they had an expensive buy/sell agreement for anyone who left.  When they said ownership wasn’t going to happen, I asked if I could invest in my own game company on the side, and they said yes, as long as it wasn’t 3D and I wasn’t coding on it.  So I invested in Crack dot Com, and produced Abuse.  After it shipped, I was starting to get royalty checks that were bigger than what I got from id in bonus checks (and they were very generous).  I was becoming more interested in producing for Crack and less interested in coding on Quake, which was starting to feel like a brown Doom with fewer monsters and a less relatable theme, so I was really slowing down.  Carmack noticed and said we should prolly part ways after Quake shipped, and I countered that I’d prefer to leave after qtest1 shipped.\\
\par
...
How do you feel looking back on this period of your life?\\ \par
...
Are you still in touch with anybody from the team of 93 ?\\ \par
\rawfq{Not much.  I exchange emails with John Carmack every once in a while.}{}
\par
