...
% More than twenty years later, the zip archive is still where it was originally placed, on id Software's FTP server.\\
Originally hosted on id Software's \cw{FTP}, the code was transitioned to \cw{github.com} where it can still be found to this day.\\
\par
