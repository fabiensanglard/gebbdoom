...
\par
 The pair worked around the clock and managed to port the GNU toolchain (\cw{cc} compiler, \cw{ld} linker, lib builder \cw{ar}, and \cw{gdb} debugger) to a PC connected to Sony's MW.2 box and demoed it at CES Las Vegas in early '94.\\
\par
 Sony liked what they saw and promptly ordered 700 dev kits. By the end of Spring '94, the devkit hardware was shrunk to two ISA cards (called DTL-H2000) combined with a SCSI drive so there was no need to burn a CD for testing.\\
