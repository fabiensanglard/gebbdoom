...
\par
 Among the numerous good choices, Sony listened to developers feedback and bumped the RAM from 1MiB to 2MiB.  They adopted a developer centric attitude where the development cycle was easy, tools updated frequently and were downloadable online, with third party technical support. The CD format allowed games to be priced lower and developers did not have to buy cartridge from Sony. More importantly Sony did not censor developers the way Nintendo and Sega did. On top of it all, royalties were lower which improved profitability\footnote{Nintendo could sometimes take up to 20\%.}. "The PlayStation set us free" Kalisto Gaming's CEO would later testify.\\
\par
...
\par
Williams Entertainment, John, and Harry had a big problem and some were really nervous about it.\\
\par
