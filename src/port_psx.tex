...
\par
\cfullimage{perspective_psx_explained.png}{}
\par
...
\par
In figure \ref{texture_anmgle}, the perspective artifact becomes exacerbated as the angle of the wall increases. Also notice in the bottom panel how the width of each square is constant in affine texturing while it decreases with distance with perspective-correct texturing.\\ 
\pagebreak
...
\par
 There would have been a way to fix this by subdividing each triangle into smaller units but in order to get a satisfactory visual result, the number of triangles had to be impossibly high.\\
\par
