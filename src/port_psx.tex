...
\par
 Sony liked what the saw and promptly ordered 700 dev kits. At the end of spring '94, the devkit hardware was shrinked into two ISA cards (called DTL-H2000) combined to an SCSI drive so there was no need to burn a CD for testing.\\

\fullimage{DTL-H2000-CPU1and2.png}
\vspace{-10pt}
\par
