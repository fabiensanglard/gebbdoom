...
\end{wrapfigure}
To convince developer to get on board and work with the PlayStation was originally difficult. On October 27, 1997 Sony gathered 300 developers representing 60 games publisher for a tour de force. They were shown the "dino demo"\footnote{Source: "PlayStation: Anthology"} which features a real-time controllable T-rex dinausor.\\
