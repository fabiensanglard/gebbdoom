...
\par
Walls \cw{A}, \cw{E}, \cw{C}, and \cw{D} mark the full height opaque for each of their columns. The first portal \cw{B} is rendered with an upper texture (to accommodate for subsector 2 lower ceiling) and a lower texture (to accommodate for subsector 2 higher floor) and adjust the occlusion array accordingly.\\
\par
...
Below, the engine was modified to draw walls and flats in plain color permit to confirm the drawing above. Hu Ho, wait a minute, this is not what was expected. Something is fishy here.\\  
