...
\par
With a visual surface determination not based on raycasting but rather on BSP, Wolfenstein 3D SNES managed to reach an acceptable framerate\footnote{\fixme{FRAMERATE?}}. Within three weeks the managed to produce "something".\\
\par
