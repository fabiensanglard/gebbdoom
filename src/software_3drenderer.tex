...
\drawing{doom_map}{}
\par
To build the BSP tree from the map, the core idea is to repeatedly select a line to split the map in two. Split lines become segments (\cw{SEGS}) and split sectors become sub-sectors (\cw{SSECTORS}).\\ 
\par
