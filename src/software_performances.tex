...
\par
 Something weirder is to notice that \cw{I\_FinishUpdate} (the microscopic red column next to \cw{G\_Ticker}) seems instantaneous. How can the DOS version transport a full framebuffer across the bus so fast? The answer is off course: It doesn't! This is because the DOS version was optimized.\\
\par
