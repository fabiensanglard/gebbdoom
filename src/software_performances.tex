...
\begin{tabularx}{\textwidth}{ R{1}  R{1} R{1} R{1}  R{1.4}  R{0.6} }
 ...
 \protect\footnotemark0x7 & 224 & 112 & 25,088 &  39 & 28 \\
...
\par
The gain\footnote{Benchmarked on a miniPC Unisys CWD 4001 (486DX2-66/CirrusLogic-GD5424, 8MiB RAM).} was not as substantial as the high/low resolution. Reducing the 3D canvas size by 50\% from 0xB to 0x8 yields only a 31\% improvement yet the visible area is so small it its almost not worth it.\\
\footnotetext{Limit of visual sanity!}
