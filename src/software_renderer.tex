...
\cw{I\_WaitVBL} & Wait for Vertical Sync.\\
   \specialrule{1pt}{0pt}{0pt}
\end{tabularx}
...
\par
\trivia{On VGA blitting is done bank after banks. SHOW CODE.}
\par
