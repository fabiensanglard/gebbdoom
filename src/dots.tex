...
\par
While developing the game, the startup time was a problem. Even if a designer made no change to the map (and therefore did not need to run \cw{doombsp}) it still took 30 seconds before he could see the result. To avoid breaking the creative flow, the engine was gifted with 