...
\par
The first step of this phase is to open a lump named \cw{PNAMES} that contains all the patch names. From the order they appear, a mapping patch name to ID is established.\\
\par
