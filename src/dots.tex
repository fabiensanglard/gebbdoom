...
\par
\fixme{This needs to be explained BETTER. Each steps. IN DETAILS. especially: what is PNAMES!}
\par
\begin{itemize}
...
\item \cw{D}: Marker to show end of \cw{R\_InitData} which encompass  \cw{T}, \cw{F}, \cw{L}, and \cw{S}.
