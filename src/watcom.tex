...
The DOS extender was magical but it was hard to setup in a standalone product. A bootstrap which would locate \cw{DOS4GW.EXE}, the program and setup both required multiple steps and close to 100 lines of C code\footnote{Source: Watcom C/C++ Programmer's Guide, "7.1.1 The Stub Program"}. The ramp up time was significant and raised the entry barrier. What was really needed was an integrated environment where the compiler and the linker would take care of bundling the extender and the application together into one executable. The solution would once again come from Canada.\\ 
\par

Watcom compiler project was started in 1979 at the University of Waterloo in Canada. Initially only supporting BASIC, it was improved over the years by students with support for new OS and languages. In 1988, three of them, Fred Crigger, Ian McPhee, and Jack Schueler made it the first C compiler running on IBM-PC.\\
\par
...
\par
Not only they were talented programmers, they were also good marketer. In early 90s, a customer could not open a computer magazine without finding a full page advertising Watcom's compiler. All ads ostensibly underlined the presence of a Dos Extender.
\par
\label{watcomad}
...
\ccode{real_mode_c.c}
\par
Notice the wart keywords such as \cw{near}, \cw{far}, macros like as \cw{FP\_OFF} and \cw{FP\_SEG}, and the \cw{DOS.H} library function such as \cw{mallocnear}, \cw{coreleft}, and \cw{farcoreleft}. None of those were part of ANSI C standard, this language was not portable.\\
\par
