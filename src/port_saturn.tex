...
\par
An other consequence of the rush was that only six games were available upon launch. Panzer Dragoon which could have made for a perfect tech flagship missed its deadline\footnote{Source: "The Making Of... Panzer Dragoon Saga".}. The way to do 3D was similar to the 3DO were programmers had to deal with quads that they distored in screen space to (poorly) fake perspective. It was not a matter of not trying hard, the hardware was complex.\\
\par
