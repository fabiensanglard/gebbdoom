...
\par 
If the black extension connectors show the traditional ISA bus ports, two 8 bit ones (\circled{2}), three dual slot 16 bit (\circled{3}) we can also see a set of three new type of connector with an additional brown slot (\circled{4}). These are VBL\footnote{Video Local Bus.}, a new type of bus up to 20x faster than ISA.
