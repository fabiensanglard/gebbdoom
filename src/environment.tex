...
\par
The most prominent novelty is of course the heart of the computer, the Intel i486 CPU (\circled{1}). Yet a closer looks reveals many more features which would turn out to be of paramount importance for the architecture of \doom.\\
\par 
