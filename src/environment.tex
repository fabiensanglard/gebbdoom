...
\trivia{On the opposite page, figure ~\ref{ibm_ps1_top} is a reproduction of a 1994 ad for an IBM PS1 featuring an Intel 486 CPU. Notice the emphasis on office work and static screen office apps capability, the only way to justify the outrageous price of the machine which represented 20\% of the US median income in 1993\footnote{Source: "statista.com".}.}\\
...
% \end{enumerate}
\pagebreak
\trivia{Several of the most impressive game studio of the era speculated on the projected price drop. Big titles of 1994 (including \doom) required a minimum of 4 MiB installed. Strike Commander, Ultima 8, and Comanche Maximum Overkill are prime examples.
