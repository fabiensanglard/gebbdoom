...
Ironically this time period would end up coinciding with the great RAM shortage of 1994 which saw the price go back up. The legend attributes the surge to a resin factory burning down in Taiwan. In all likelihood the fluctuation was probably due to Microsoft's release of Windows 95, which recommended a machine with 8 MiB of RAM.
\vspace{10pt}
\begin{center}
\begin{tikzpicture}
