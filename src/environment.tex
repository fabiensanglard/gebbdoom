...
\item A price tag where a top of line machine fetched close to \$6,000. To compare with the competitions, the SNES and the SEGA Genesis were both priced at US\$199 while the Neo-Geo which provided arcade-like experience was priced at US\$649.99\footnote{Adjusted to inflation the figure would be at of 2018 \$10,476 for a PC, \$377.00 for a SNES/Nemesis, and \$1,134 for a Neo-Geo.}.
\end{itemize}
\par
...
\par
Notice the ridiculously small 14" CRT standard monitor allowing "up to" 800x600 resolution.
...
\par 
The black connectors show the traditional ISA bus extension ports. One 8-bit \circled{2} and three dual slot 16-bit \circled{3} allow four cards. Also present, three new type of connector with an additional brown slot \circled{4}. These are VLB\footnote{a.k.a: VL-Bus, a.k.a: Video Local Bus.}, a new type of bus up to 20x faster than ISA.
