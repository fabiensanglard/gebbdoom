...
\par
\scaleddrawing{1}{SRAM}{Static RAM made of six transitors}
\par
...
\par
But the FPU performance was still a far cry compared to the the ALU and its barrel shifter. This mandated \doom{} to use integer operations exclusively\footnote{The dawn of floating points would beging with Intel's Pentium and Quake in 1996.}.\\
