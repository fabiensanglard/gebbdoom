...
\par
Since it was tied to a timer, DMX was also in charge of the game engine heartbeat via a variable called \cw{ticcount}. Everything in \doom{} uses that variavle to paced itself.
\par
