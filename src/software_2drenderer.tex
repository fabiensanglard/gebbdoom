...
\par
Every time a screen refresh is needed, the intermission code does a \cw{memcpy} (called a "slam" in the code) from FrameBuffer \#1 to Framebuffer \#0, then draws sprites and text on top of it.\\
\par
