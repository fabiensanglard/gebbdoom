...
In its early instances, \doom~featured a HeadUp Display minicking doomguy helmet.\\
\par
...
\par
\trivia{Automap almost featured an easter egg. Files \cw{am\_oids.h/c} were to allow player to play a remake of Asteroids. Unfortunatly the easter egg was left unfinished.}\\
\par
