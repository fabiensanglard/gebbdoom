...
All drawers of \doom were the work of  Dave Taylor. The self proclaimed "spackle coder" of the team was only hired three months before the game shipped but he still managed to produce many systems.
\begin{itemize}
...
\par
It takes whatever is in FrameBuffer \#2 and progressively transforms it into what is stored in FrameBuffer \#3, writing the output in FrameBuffer \#0.\\% (FrameBuffer \#1 is left available in case a screenshot request was received in the middle of a wipe.).\\
\par
